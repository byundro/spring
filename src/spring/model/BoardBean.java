...
public class BoardBean {
	...
	/*
	 * public String list(@RequestParam(defaultValue="1",required = true) int
	 * pageNum, Model model) throws Exception {
	 */
	public String list(@RequestParam(defaultValue="1",required = true) int pageNum, Model model) throws Exception {
		//페이지 번호 받음
			
		//인트의 기본값은 0 위에서 언노테이션 디폴트밸류=1을 넣어서 필요없어짐.
		/*
